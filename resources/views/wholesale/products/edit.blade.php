                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group wholesale-aizuploader-trigger" data-toggle="aizuploader" data-type="image" data-multiple="true" onclick="return triggerWholesaleUploader(event, this)">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group wholesale-aizuploader-trigger" data-toggle="aizuploader" onclick="return triggerWholesaleUploader(event, this)">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                    </div>
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
...
<script type="text/javascript">
    ...
    function triggerWholesaleUploader(event, element) {
        if (event) {
        ...
        var $element = $(element);
        var multiple = $element.data('multiple') ? $element.data('multiple') : '';
        var type = $element.data('type') ? $element.data('type') : '';
        var selectedFiles = $element.find('.selected-files').val() || '';

        AIZ.uploader.trigger(element, 'input', type, selectedFiles, multiple);
        return false;
    }
