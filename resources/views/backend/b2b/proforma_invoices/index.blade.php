...
@section('content')
    <div class="aiz-titlebar text-left pb-3">
        <h1 class="h3">{{ translate('B2B Proforma Invoices') }}</h1>
    </div>
                ...
                <tbody>
                    @forelse ($invoices as $invoice)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ route('admin.b2b.proforma-invoices.show', $invoice->id) }}" class="btn btn-soft-primary btn-icon btn-circle btn-sm">
                    ...
                    @empty
                        <tr>
                            <td colspan="11" class="text-center">{{ translate('No proforma invoices found') }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
