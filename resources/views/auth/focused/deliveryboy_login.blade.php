            ...
            <div class="row no-gutters" style="min-height: 100vh;">
                ...
                <div class="col-xxl-9 col-lg-8">
                    <div class="h-100" style="max-height: 100vh">
                        <img src="{{ uploaded_asset(get_setting('delivery_boy_login_page_image')) }}" alt="{{ translate('Customer Login Page Image') }}" class="img-fit h-100">
                    </div>
                </div>
                    ...
                    <div class="d-flex align-items-center right-content">
                        <div class="py-3 py-lg-4 px-3 px-xl-5 flex-grow-1">
                            ...
                            <div class="text-center text-lg-left">
                                ...
                                <h5 class="fs-14 fw-400 text-dark">{{ $portalTitle }}</h5>
                            </div>
                                    ...
                                    @if (env("DEMO_MODE") == "On")
                                        <div class="mb-4">
                                            <table class="table table-bordered mb-0">
                                                <tbody>
                                                    <tr>
                                                        <td>{{ $isLogisticPortal ? translate('Logistic Worker Account') : translate('Delivery Boy Account') }}</td>
