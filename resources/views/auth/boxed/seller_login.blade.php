                                ...
                                <div class="mb-4">
                                    <div class="water-color-alert" style="
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <span class="fs-12 fw-600">{{ translate('Seller Account')}}</span>
                                            <button class="btn btn-sm" onclick="autoFillSeller()" style="
                            ...
                            <div class="text-center pt-3 border-top" style="border-color: rgba(0,0,0,0.1) !important;">
                                <p class="fs-12 text-gray mb-0">
                                    ...
                                    <a id="register-link" href="{{ $registerRoute }}" class="ml-2 fs-14 fw-700" style="
                                            background: linear-gradient(45deg, #e62e04, #ff9900);
                                            -webkit-background-clip: text;
                                            -webkit-text-fill-color: linear-gradient(45deg, #e62e04, #ff9900);
