                    ...
                    <div class="row align-items-center">
                     ...
                     <div class="d-flex justify-content-between mt-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-1 ml-1">{{ translate('Add New Product') }}</p>
                        </div>
                        </a>
                     </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <div class="d-flex align-items-center pt-1">
                            ...
                            <p class="fs-12 text-light my-1 ml-1">{{ translate('Followers').' '.$authUser->shop?->followers()->count() }}</p>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-1 ml-1">{{ translate('Custom Followers').' '.$authUser->shop?->custom_followers }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <p class="fs-12 text-light my-1 ml-1">{{ translate('View All Order') }}</p>
                        </div>
                        </a>
                     </div>
                </div>
            ...
            <div class="card shadow-none mb-4 bg-primary ">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mt-3">
                        <a href="{{ route('seller.orders.index') }}">
                        <div class="d-flex align-items-center">
                            <p class="fs-12 text-light my-1 ml-1"> {{ translate('Last Month') }}: {{ single_price($previous_month_sold_amount) }}</p>
                        </div>
                        </a>
                     </div>
                </div>
    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            ...
            <div class="card shadow-none bg-soft-primary mb-0">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600 mb-1">
                        {{ translate('Sold Amount') }}
                    </div>
                    <p class="mb-1">{{ translate('Your Sold Amount (Current month)') }}</p>
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title ">
                            <h6 class="mb-0 text-primary fs-16 fw-600">{{ translate('Purchased Package') }}</h6>
                        </div>
                                ...
                                <div class="col-9">
                                    ...
                                    <h6 class="text-primary">
                                        ...
                                        @if(addon_is_activated('preorder'))
                                            <p class="mb-1 text-muted">{{ translate('Preorder Upload Limit') }}:
            ...
            @endif
            <div
                class="card mb-0 @if (addon_is_activated('seller_subscription')) px-4 py-4 @else p-5 h-100 @endif d-flex align-items-center justify-content-center">
        ...
        AIZ.plugins.chart('#graph-1', {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#e9e9f0', '#e9e9f0', '#e9e9f0', '#e9e9f0', '#e9e9f0', '#e9e9f0',
                        '#e9e9f0'
                    ],
                    borderColor: ['#e9e9f0', '#e9e9f0', '#e9e9f0', '#e9e9f0', '#e9e9f0', '#e9e9f0',
                        '#e9e9f0'
                    ],
                    borderWidth: 1
                }]
