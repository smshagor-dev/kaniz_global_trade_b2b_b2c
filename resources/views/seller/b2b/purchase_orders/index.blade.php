...
@section('panel_content')
    <div class="aiz-titlebar mt-2 mb-4">
        <h1 class="h3">{{ translate('Purchase Orders') }}</h1>
    </div>
                ...
                <tbody>
                    @forelse ($purchaseOrders as $purchaseOrder)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ route('seller.b2b.purchase-orders.show', $purchaseOrder->id) }}" class="btn btn-soft-primary btn-icon btn-circle btn-sm">
