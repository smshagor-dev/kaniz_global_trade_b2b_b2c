                        ...
                        <ul class="list-unstyled mt-3">
                            ...
                            <li class="mb-2 pb-2 {{ areActiveRoutes(['b2b.portal.become-supplier'], ' active') }}">
                                <a href="{{ route('b2b.portal.become-supplier') }}"
                                    class="fs-13 text-soft-light text-sm-secondary  @if(get_setting('footer_text_color') == 'black' || get_setting('footer_text_color') == '#000') animate-underline-black @else animate-underline-white @endif ">{{ translate('Become A Supplier') }}</a>
                            </li>
                            <li class="mb-2 pb-2 {{ areActiveRoutes(['buyer.portal'], ' active') }}">
                                <a href="{{ route('buyer.portal') }}"
                                    class="fs-13 text-soft-light text-sm-secondary  @if(get_setting('footer_text_color') == 'black' || get_setting('footer_text_color') == '#000') animate-underline-black @else animate-underline-white @endif ">{{ translate('Buyer Portal') }}</a>
                            </li>
                            @guest
