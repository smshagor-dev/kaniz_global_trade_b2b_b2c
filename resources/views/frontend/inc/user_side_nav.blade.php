                ...
                @if (addon_is_activated('preorder'))
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('preorder.order_list') }}" class="aiz-side-nav-link {{ areActiveRoutes(['preorder.order_list']) }}">
                ...
                @if (Route::has('b2b.ai.dashboard') && (get_setting('b2b_ai_visible') === null || (int) get_setting('b2b_ai_visible') === 1))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('b2b.ai.dashboard') }}"
                            class="aiz-side-nav-link {{ areActiveRoutes(['b2b.ai.dashboard', 'b2b.ai.rfq-assistant', 'b2b.ai.hs-code', 'b2b.ai.trade-assistant', 'b2b.ai.price-recommendation', 'b2b.ai.freight-recommendation', 'b2b.ai.currency-analysis', 'b2b.ai.trade-finance', 'b2b.ai.opportunities', 'b2b.ai.notifications', 'b2b.ai.dashboard-insights']) }}">
