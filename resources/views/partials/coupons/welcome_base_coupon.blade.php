<div class="card-header mb-2 pl-0">
    <h3 class="h6">{{translate('Add Your Customer Welcome Coupon')}}</h3>
</div>
...
<div class="form-group row">
    <label class="col-12 control-label" for="start_date">{{translate('Validation Days')}}</label>
    <div class="col-12">
      <div class="input-group">
        <input type="number" class="form-control" name="validation_days" min="1" step="1" placeholder="{{ translate('Validation Days') }}">
