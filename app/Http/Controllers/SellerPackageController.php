...
class SellerPackageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($seller_package->save()) {
            $sellerPackageTranslation = SellerPackageTranslation::firstOrNew([
                'lang' => env('DEFAULT_LANGUAGE'),
                'seller_package_id' => $seller_package->id,
            ]);
            $sellerPackageTranslation->name = $request->name;
            $sellerPackageTranslation->save();
    ...
    public function destroy($id)
    {
        ...
        foreach ($seller_package->seller_package_translations as $sellerPackageTranslation) {
            $sellerPackageTranslation->delete();
        }
